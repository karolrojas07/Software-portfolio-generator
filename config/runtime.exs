...
if config_env() in [:dev, :test] do
  ...
  config :software_portfolio_generator, SoftwarePortfolioGenerator.Repo,
    ...
    database: System.get_env("DB_DATABASE", "software_portfolio_generator_dev"),
...
#
#     PHX_SERVER=true bin/software_portfolio_generator start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :software_portfolio_generator, SoftwarePortfolioGeneratorWeb.Endpoint, server: true
end
