...
Repo.insert!(%ProjectTechnology{project_id: 8, technology_id: 1})
Repo.insert!(%ProjectTechnology{project_id: 8, technology_id: 8})
Repo.insert!(%ProjectTechnology{project_id: 8, technology_id: 9})
Repo.insert!(%ProjectTechnology{project_id: 8, technology_id: 21})
Repo.insert!(%ProjectTechnology{project_id: 8, technology_id: 18})
Repo.insert!(%ProjectTechnology{project_id: 8, technology_id: 22})
Repo.insert!(%ProjectTechnology{project_id: 8, technology_id: 25})
Repo.insert!(%ProjectTechnology{project_id: 8, technology_id: 27})
Repo.insert!(%ProjectTechnology{project_id: 8, technology_id: 31})
Repo.insert!(%ProjectTechnology{project_id: 8, technology_id: 35})
Repo.insert!(%ProjectTechnology{project_id: 8, technology_id: 41})
